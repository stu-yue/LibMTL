...
class SKExtr(nn.Module):
    def __init__(self, out_dim, in_feats=2, input_shape=(300, 9), nums_block_list=[2, 2, 2, 2], stride_list=[1, 2, 2, 1], pool_method="gap"):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.extractor = nn.Sequential(                                                                     # (bz, 2, T, c)
            SKExtr(out_dim=1024, in_feats=2, nums_block_list=[1,1,1,1], stride_list=[1,2,4,1], pool_method=pool_method),    # (bz, T, dim)
